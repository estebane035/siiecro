jQuery(document).ready(function($) {
	_cargarTabla(
			...
			"/dashboard/obras-epoca/carga", // URL datos
			[
				{ data: "id", 		      width: "10%"},
...
function crear(){
  _mostrarFormulario("/dashboard/obras-epoca/create", //Url solicitud de datos
...
function editar(id)
{
    _mostrarFormulario("/dashboard/obras-epoca/"+id+"/edit/", //Url solicitud de datos
                        "#modal-1", //Div que contendra el modal
                        "#modal-crear", //Nombre modal
                        "#name", //Elemento al que se le dara focus una vez cargado el modal
                        function(){
...
{
  _mostrarFormulario("/dashboard/obras-epoca/"+id+"/eliminar/", //Url solicitud de datos
                      "#modal-1", //Div que contendra el modal
