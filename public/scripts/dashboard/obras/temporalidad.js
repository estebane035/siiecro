jQuery(document).ready(function($) {
	_cargarTabla(
			...
			"/dashboard/obras-temporalidad/carga", // URL datos
			[
				{ data: "id", 		      width: "10%"},
...
function crear(){
  _mostrarFormulario("/dashboard/obras-temporalidad/create", //Url solicitud de datos
                      ...
                      "#form-obras-temporalidad", //ID del Formulario
...
function editar(id)
{
    _mostrarFormulario("/dashboard/obras-temporalidad/"+id+"/edit/", //Url solicitud de datos
                        "#modal-1", //Div que contendra el modal
                        "#modal-crear", //Nombre modal
                        "#name", //Elemento al que se le dara focus una vez cargado el modal
                        function(){
...
{
  _mostrarFormulario("/dashboard/obras-temporalidad/"+id+"/eliminar/", //Url solicitud de datos
                      "#modal-1", //Div que contendra el modal
