    ...
    <div class="modal-dialog modal-sm">
    	<div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <small class="font-bold">Eliminar Muestra con Id # <strong>{{ $registro->id }}</strong> de la Solicitud de Análisis</small>
            </div>
            ...
            <div class="modal-body">
            	<div class="row">
            		<p>¿Estas seguro que deseas eliminar la Muestra <strong>{{ $registro->no_muestra }}</strong> con el Id # <strong>{{ $registro->id }}</strong>?</p>
            	</div>
